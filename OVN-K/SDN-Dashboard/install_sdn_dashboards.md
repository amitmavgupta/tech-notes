...
Install Service Monitor (reference svc_monitor.yaml)
...
Note: By default OVN-K has moved to IC mode. For Centralized mode, the support was available till release 1.0.0

This will provide you with three handy dashboards for 
